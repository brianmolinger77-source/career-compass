...
import { useFieldRetry } from '../utils/autosave'
...
export default function RoleCard({
  ...
  const { fieldStatuses, triggerFieldSave, handleManualRetry, FieldSaveStatus } = useFieldRetry({
    resetKey: role.id,
    onSave: patch => onUpdate(role.id, patch),
    onEmergencyFlush: patch => onEmergencyFlush(role.id, patch)
  })
