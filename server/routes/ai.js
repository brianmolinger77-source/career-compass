...
DIFFERENCES — Gaps or mismatches between this posting and this veteran's specific profile that are worth noting but are not direct conflicts. Each difference must pass this test: could this observation be made about a different veteran with a completely different background applying to this same posting? If yes, discard it — it belongs to the posting, not to this veteran. Before including any difference, complete this check: "The posting specifically says [X]. This veteran's profile specifically shows [Y]. These are different because [Z]." If you cannot fill in all three blanks with specific text from the posting and specific text from the profile, do not include the item. BANNED PATTERNS — never include any of these regardless of how they are phrased: any reference to industry mismatch (financial services vs military, corporate vs operational, enterprise vs tactical), any reference to environment mismatch (civilian workplace vs military, corporate culture vs service culture), any observation that would be identical if this veteran had a logistics background, a medical background, or any other non-financial-services background. A legitimate difference is about a specific skill, responsibility, or requirement in the posting that diverges from a specific documented experience in this veteran's profile — nothing else. Frame genuine differences neutrally as observations, not problems.
